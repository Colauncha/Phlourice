...
{/* Marquee Section */}
  ...
  <Marquee autoFill pauseOnHover speed={30} className="w-full">
    <div className="border border-green-600 m-1 rounded-full flex space-x-5 px-8 py-2 text-green-600 text-xl cursor-pointer 
               hover:bg-green-700 hover:text-white hover:scale-105 hover:shadow-md 
               transition-all duration-300 transform-gpu">
      Natural Gas Facilities
    </div>
    <div className="border-1 border-green-600 m-1 rounded-full flex space-x-5 px-8 py-2 text-green-600 text-xl cursor-pointer 
               hover:bg-green-700 hover:text-white hover:scale-105 hover:shadow-md 
               transition-all duration-300 transform-gpu">
 ...
 <div className="max-w-8xl mx-auto mb-30 px-4">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-[1.7fr_1.1fr_1.1fr] gap-x-10 gap-y-12 h-full items-stretch">
        ...
        <motion.div
          ...
          transition={{ duration: 0.8, ease: "easeOut" }}
        >
          <div className="inline-block border-2 border-green-600 rounded-2xl px-4 py-2 w-fit mb-8">
            <h2 className="text-5xl font-semibold py-2 text-black">What we do</h2>
          </div>

          <div className="text-6xl md:text-5xl leading-tight space-y-1 mb-4">
            <p><span className="text-green-700">Discover</span> Everything</p>
            <p><span className="text-green-700">About</span> Phlouriche</p>
            <p><span className="text-green-700">Nigeria</span> Limited's</p>
            <p><span className="text-green-700">Engineering</span></p>
            <p><span className="text-green-700">Solutions.</span></p>
          </div>

          <p className="text-base md:text-lg text-black text-justify mt-2">
            Phlouriche Nigeria Limited is your trusted partner in delivering innovative engineering solutions tailored for the energy sector.
            Our expertise spans the comprehensive design, operation, and maintenance of Natural Gas facilities—covering NG, CNG, and LNG—as
            well as Independent Power Plants.
          </p>
        </motion.div>
          ...
          <div className="relative w-full h-full">
            ...
            <div className="absolute inset-0 p-6.5 bg-black/30 rounded-2xl flex flex-col justify-between">
              ...
              <div className="text-white/90 text-[16px] rounded-2xl p-6.5 bg-white/30">
                <p className="text-white/90 text-[20px] font-xl font-bold mb-2">Natural Gas Solutions</p>
                <p>Our expertise in NG, CNG, and LNG facilities ensures top-tier solutions.</p>
              </div>
            </div>
          </div>
        </motion.div>
        ...
        >
          <div className="relative w-full h-full mb-8">
            ...
            <div className="absolute inset-0 p-6.5 bg-black/30 rounded-2xl flex flex-col justify-between">
              ...
              <div className="text-white/90 text-[16px] rounded-2xl p-6.5 bg-white/25">
                <p className="text-white/90 text-[20px] font-xl font-bold">Independent Power Plant</p>
                <p>Delivering reliable energy solutions through advanced design and maintenance.</p>
              </div>
            </div>
          </div>
          ...
          <div className="mb-12">
            <p className="text-base md:text-lg text-black">
              Ensure uninterrupted power supply with our integrated approaches to facility maintenance and equipment supply.
            </p>
          </div>
        </motion.div>
      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-center">
            ...
            <div className="order-1 md:order-2 space-y-6">
              ...
              <p className="text-lg text-gray-600 leading-relaxed">
                Our extensive experience in pipeline construction ensures that every project is executed with precision, 
        ...
        >
          <div>
            <h4 className="text-2xl md:text-3xl font-bold text-gray-800 leading-tight">
              Transform Your Energy Projects with Phlouriche Nigeria Limited.
            </h4>
          </div>
          <div>
            <img 
...
<div className="max-w-8xl mx-auto mt-5 mb-30 px-4">
      ...
      >
        <h2 className="text-3xl sm:text-4xl md:text-5xl font-semibold py-2 text-black">Our Services</h2>
      </motion.div>
      ...
      >
        <div className="w-full max-w-310 lg:w-310 h-auto lg:h-205 rounded-2xl p-6 sm:p-10 md:p-15 flex flex-col bg-white z-10 shadow-[0_0_20px_rgba(0,0,0,0.15)] overflow-hidden">
          ...
          <div className="flex flex-col h-full">
            ...
            >
              Phlouriche Nigeria Limited offers a wealth of expertise in the design, operation, and maintenance of Natural Gas facilities and Power Plants. Our commitment to delivering high-quality equipment and tailored solutions ensures that your projects achieve optimal performance and reliability.
            </motion.p>
...
<div className="max-w-8xl mx-auto mt-10 mb-30">
  <div className="inline-block border-2 border-green-600 rounded-2xl px-4 py-2 w-fit mb-15">
    <h2 className="text-5xl font-semibold py-2 text-black">Our Projects</h2>
  </div>
  ...
  <div className="overflow-hidden">
    ...
    >
      {projects.map((project, index) => (
        <SwiperSlide key={index} className="!w-auto first:!ml-[var(--swiper-padding)]">
          <img 
            src={project.img} 
            alt={project.alt}
...
<div className="w-auto mx-auto mt-10 mb-30 flex flex-col items-center text-center bg-green-100 p-6">
      <div className="max-w-auto w-auto ">
        ...
        <motion.p
          ...
          transition={{ duration: 0.8, ease: "easeOut", delay: 0.2 }}
        >
          As promised, we have delivered uncompromising Technical and professional Services to several clients on different projects and below are some of our happy clients…
        </motion.p>

     
        <div className="flex flex-wrap justify-center gap-8 mb-8">
          {[pepsico, industrial, aggreco, okFood, walter, boc].map((logo, index) => (
            <motion.img
              key={`top-${index}`}
              src={logo}
              alt="Client logo"
              ...
              {...logoAnimation}
              transition={{ ...logoAnimation.transition, delay: index * 0.1 }} // Stagger logos
            />
          ))}
        </div>
